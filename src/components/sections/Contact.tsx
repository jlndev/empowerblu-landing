    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-lg text-gray-700 mb-8">
          Our team is ready to help you transform your trade business with our powerful management platform.
        </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="flex items-center justify-center">
            ...
            <a href="mailto:team@empowerblu.com" className="text-blue-600 hover:underline">team@empowerblu.com</a>
          </div>
